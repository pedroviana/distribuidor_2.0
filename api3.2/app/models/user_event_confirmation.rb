...
class UserEventConfirmation < ActiveRecord::Base
  ...
  #attr_accessible *column_names, :blank_midia_attachment, :token, :name, :company, :celnumber, :revistas, :outra_revista, :le_jornal, :jornais, :jornais_acres_other, :jornais_alagoass, :jornais_alagoass_other, :jornais_amazonass_other, :jornais_bahias_other, :jornais_cears_other, :jornais_distrito_federals_other, :jornais_esprito_santos_other, :jornais_goiss_other, :jornais_goinias_other, :jornais_maranhos_other, :jornais_mato_grosso_do_suls_other, :jornais_minas_geraiss_other, :jornais_parans_other, :jornais_parabas_other, :jornais_pernambucos_other, :jornais_piaus_other, :jornais_rio_grande_do_nortes_other, :jornais_rio_grande_do_suls_other, :jornais_rio_de_janeiros_other, :jornais_rondnias_other, :jornais_roraimas_other, :jornais_santa_catarinas_other, :jornais_so_paulos_other, :jornais_sergipes_other, :radios, :tipo_musica_other, :outra_radio, :canais, :canais_fechados, :outros_canais, :programas_preferidos, :locais_internet, :o_que_ve_internet, :outros_sites, :quais_redes_sociais, :quais_blogs, :outras_redes, :sites_especializados, :outro_site_especializado, :le_revista, :jornais_acres, :jornais_amazonass, :jornais_bahias, :jornais_cears, :jornais_distrito_federals, :jornais_esprito_santos, :jornais_goiss, :jornais_goinias, :jornais_maranhos, :jornais_mato_grosso_do_suls, :jornais_minas_geraiss, :jornais_parans, :jornais_parabas, :jornais_pernambucos, :jornais_piaus, :jornais_rio_grande_do_nortes, :jornais_rio_grande_do_suls, :jornais_rio_de_janeiros, :jornais_rondnias, :jornais_roraimas, :jornais_santa_catarinas, :jornais_so_paulos, :jornais_sergipes, :ouve_radio, :tipo_musica, :assisti_tv, :frequencia_tv, :envia_recebe_sms, :usa_internet, :frequencia_internet, :acessa_redes_sociais
