...
ActiveAdmin.register_page "Log Cliente" do
      ...
      column do
        ...
        panel "Últimas atividades" do
          ...
          # Reversing the array to show the most recent updates
      		...
      		table_for PaperTrail::Version.where('item_type = "User"').order('created_at DESC').each do |p|
            ...
            # =================================
              ...
              link_to "#{p.reify.title}", undelete_admin_user_path(p) if p.event == 'destroy'
      		  end
            # =================================
        	end
        end     
