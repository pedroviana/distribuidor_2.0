...
ActiveRecord::Schema.define(version: 20130906190334) do
  ...
  add_index "admin_user_type_areas", ["admin_user_type_id"], name: "index_admin_user_type_areas_on_admin_user_type_id", using: :btree
  add_index "admin_user_type_areas", ["area_id"], name: "index_admin_user_type_areas_on_area_id", using: :btree
