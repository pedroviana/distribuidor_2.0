...
ActiveAdmin.register_page "Log Usuário" do
      ...
      column do
        ...
        panel "Últimas atividades" do
          ...
          # Reversing the array to show the most recent updates
      		...
      		table_for PaperTrail::Version.where('item_type = "AdminUser"').order('created_at DESC').each do |p|
        		...
        		column "O que" do |p|
        		  ...
        		  if record
        			  link_to record.title, admin_admin_user_path(record) 
            ...
            # =================================
              ...
              link_to "#{p.reify.title}", undelete_admin_admin_user_path(p) if p.event == 'destroy'
      		  end
            # =================================
        	end
        end     
